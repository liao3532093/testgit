...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            init();
            //改变每页数据条数,例如改为50
            $("#expected_results_table").datagrid('getPager').pagination('refresh', {pageSize: 50});
        });
    </script>
</head>
<body class="easyui-layout">
<div id="expected_results_top">
    <fieldset style="margin: 10px;">
        <legend>用例模块信息</legend>
        <div>
            <font color="green">用例标题：</font><font id="config_detail_title"></font>&nbsp;&nbsp;
            <font color="green">所属模块：</font><font id="request_name"></font>&nbsp;&nbsp;
            &nbsp;&nbsp;<input type="button" value="添加预期结果" onclick="add_exp_result()" style="width: 100px;"/>
        </div>
    </fieldset>
</div>
<div region="center" class="pad-10">
    <table id="expected_results_table" class="easyui-datagrid"
           url="${root}/example/selectExpectedResultsAll.asp"
           pagination="true" fit="true" style="width: 1800px;height: 100%" nowrap="false"
           rownumbers="false" fitColumns="true" singleSelect="true" toolbar="#expected_results_top">
        <thead>
        <tr>
            <th field="id" width="80" align="center">预期ID</th>
            <th field="expectTypeName" width="120" align="center">预期类型</th>
            <th field="detail" width="200" align="center">预期结果详情</th>
            <th field="sqlName" width="200" align="center" formatter="operscript">执行脚本</th>
            <th field="eValue" width="100" align="center">预期值</th>
            <th field="orderNum" width="60" align="center">顺序</th>
